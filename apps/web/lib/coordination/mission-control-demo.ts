...
} from "@/lib/coordination/mission-control-model";
...
const SCRIPTS: Record<string, string[]> = {
  ...
  "a-ui": [
    "Reading components/workspace/repository-picker.tsx",
      ...
      agent(
        {
          ...
          brief: {
            ...
            status: "blocked",
            filesLikelyToTouch: [
              "components/workspace/repository-picker.tsx",
          ...
          files: [
            {
              path: "components/workspace/repository-picker.tsx",
              added: 37,
              removed: 12,
              claimed: true,
            },
