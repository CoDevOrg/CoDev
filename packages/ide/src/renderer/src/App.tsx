...
function App(): React.JSX.Element {
  ...
  const storeActiveView = useAppStore((s) => s.activeView)
  // CoDev personal settings surface: this client was opened outside any
  // workspace to render the member's own settings, so Settings is the only
  // reachable view.
