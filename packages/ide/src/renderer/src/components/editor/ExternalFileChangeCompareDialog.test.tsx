...
describe('ExternalFileChangeCompareDialog', () => {
  ...
  it('shows the disk version left and the buffer right once the read resolves', async () => {
    ...
    expect(document.body.textContent).toContain('External file conflict')
    expect(document.body.textContent).toContain('Both versions are preserved')
    ...
    expect(document.body.textContent).toContain('Save manual merge')
  })
