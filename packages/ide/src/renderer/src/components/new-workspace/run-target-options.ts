...
/** A row in the run-target list. Hosts commit; the last one opens a submenu. */
...
/**
 * Filters hosts by a typed query. The "Add host" row always survives, so it
 * stays reachable in every state including no-matches.
 */
