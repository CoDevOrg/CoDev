...
import { CodevWorkboardPanel } from './CodevWorkboardPanel'
import { startCodevWorkboardSession } from './codev-workboard-store'
  ...
  const handleCreateWorktree = useCallback(
    (workspaceStatus: WorkspaceStatus) => {
      if (typeof window !== 'undefined' && window.__CODEV_EMBEDDED__) {
        void startCodevWorkboardSession()
        return
      }
      createWorktreeForStatus(workspaceStatus)
    },
    [createWorktreeForStatus]
  )
