...
function Settings(): React.JSX.Element {
  ...
  const codevExtraPersonalSections: SettingsNavSection[] = useMemo(
    () => [
      {
        id: 'codev-profile',
        title: 'Profile',
        ...
        searchEntries: [
          {
            title: 'Profile',
            description: 'Your CoDev display name, email, and connected accounts.',
            keywords: ['profile', 'identity', 'name', 'email', 'account', 'google', 'github']
          }
        ]
      }
    ],
              ...
              <ActiveSettingsSectionProvider value={activeSectionId}>
                ...
                {isSectionMounted('codev-profile') ? (
                  <SettingsSection
                    ...
                    title="Profile"
                    description="The identity and contact details connected to your CoDev account."
                    searchEntries={getSectionSearchEntries('codev-profile')}
                  >
                    <CodevProfileSection />
                  </SettingsSection>
                ) : null}
