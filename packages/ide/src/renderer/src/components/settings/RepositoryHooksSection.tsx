  ...
  return [
    ...
    },
    {
      ...
      description: translate(
        ...
        'Ignore codev.yaml; run only your local commands.'
      )
    },
    {
      policy: 'run-both',
      ...
      description: translate(
        ...
        'codev.yaml first, then your local commands.'
      )
    }
  ]
}
    ...
    case 'update-available':
      return {
        heading: translate(
          ...
          '`codev.yaml` could not be parsed'
        ),
        description: translate(
    ...
    default:
      return {
        heading: translate(
          ...
          'No `codev.yaml` detected'
        ),
        description: translate(
          'auto.components.settings.RepositoryHooksSection.b20c5df6ca',
          'Add an `codev.yaml` file to enable shared setup, archive, or issue-automation defaults for this repo. Example template:'
        )
      }
  }
}
    ...
    <div className="space-y-2">
      <p className="text-[10px] tracking-[0.18em] text-muted-foreground">
        ...
        <code className="rounded bg-muted px-1 py-0.5">
          {translate('auto.components.settings.RepositoryHooksSection.39da2ae12f', 'codev.yaml')}
        </code>{' '}
          ...
          <p className="text-xs leading-5 text-muted-foreground">
            {isChecking
              ? translate(
                  ...
                  'Local scripts are saved. Orca is still checking codev.yaml before it can recommend which script source to use.'
                )
              : translate(
                  'auto.components.settings.RepositoryHooksSection.0ce113fd7b',
                  'Local scripts are saved, but Script Source is set to codev.yaml only.'
                )}
          </p>
        </div>
      </div>
  ...
  const advancedMatchesSearch =
    ...
    matchesSettingsSearch(settingsSearchQuery, {
      ...
      description: translate(
        ...
        'Command source and codev.yaml details.'
      ),
      keywords: [
      ...
      <div className="space-y-1">
        ...
        <p className="text-xs text-muted-foreground">
          {translate(
            ...
            'Scripts that run when worktrees are created or archived. Local scripts are stored on this machine; `codev.yaml` scripts are shared with your team.'
          )}
        </p>
      </div>
