...
describe('handleTerminalFileDrop', () => {
  ...
  it('uploads client-local drops into the active runtime before pasting paths', async () => {
      ...
      results: [
        {
          ...
          status: 'imported',
          destPath: '/remote/repo/.codev/drops/logo.png',
          kind: 'file',
          renamed: false
        }
      ]
    ...
    expect(sendInput).toHaveBeenCalledWith(
      wrapTerminalBracketedPasteText('/remote/repo/.codev/drops/logo.png')
    )
  ...
  it('uploads to the worktree owner runtime instead of the focused runtime', async () => {
      ...
      results: [
        {
          ...
          status: 'imported',
          destPath: '/remote/repo/.codev/drops/spec.pdf',
          kind: 'file',
          renamed: false
        }
      ]
    ...
    expect(sendInput).toHaveBeenCalledWith('/remote/repo/.codev/drops/spec.pdf ')
  })
