...
// The default local root for the agent whose subagent transcripts are read
// back by renderer-supplied path (Claude). Discovery scans this; the IPC
// lister uses the root enumeration below to reject arbitrary paths.
