 ...
 * that ignores signals.
 */
export const REMOTE_URL_PROBE_TIMEOUT_MS = 30_000

export type RemoteUrlProbeContext = {
  repoPath: string
  /** Legacy remote-target id; ignored (every repo is local to this host). */
  connectionId?: string | null
  wslDistro?: string
}

/** Reads a remote URL (null is reserved for callers that cannot reach git). */
