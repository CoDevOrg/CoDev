...
export const serverEnvironmentSchema = z.object({
  ...
  HOSTED_CODEX_APPROVED_CLIENT_ID: z.string().min(1).optional(),
  HOSTED_CODEX_APPROVED_CLIENT_SECRET: z.string().min(1).optional(),
  HOSTED_CODEX_APPROVED_AUTHORIZE_URL: optionalUrl,
  HOSTED_CODEX_APPROVED_TOKEN_URL: optionalUrl,
  HOSTED_CODEX_APPROVED_REVOCATION_URL: optionalUrl,
  HOSTED_CODEX_APPROVED_REDIRECT_URI: optionalUrl,
  HOSTED_CODEX_APPROVED_ISSUER: optionalUrl,
  HOSTED_CODEX_APPROVED_SCOPE: z.string().min(1).optional(),
  HOSTED_CODEX_APPROVED_RUNTIME_GRANT_URL: optionalUrl,
  HOSTED_CODEX_KMS_KEY_ID: z.string().min(1).optional(),
